...
<div class="row text-center">
  <div class="col-sm-6">
    <div class="card alert alert-dark">
      <div class="card-body">
        <h5 class="card-title"> Are you a member?</h5>
        <p class="card-text">Sign up here with Pinnacle Health and Fitness today.</p>
        <a href="/signup.php" class="btn btn-dark">Become a member</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
