			...
			echo "<div class=\"col form-group mx-auto\">
					...
					<input class=\"form-control\" type=\"text\" name=\"name\" id=\"name\" value=\"$c_name\"/>
						...
						echo"       </select>
							  ...
							  <button id=\"action\" name=\"action\" value=\"update_details\" class=\"btn btn-info mt-2 mb-4 \" type=\"submit\">Update Details</button>
							  <button id=\"action\" name=\"action\" value=\"update_password\" class=\"btn btn-info mt-2 mb-4 \" type=\"submit\">Update Password</button>
